...
_dataBusiness.getCharacters().then((data)=>{
    ...
    for (let character of characters){
        ...
        node.onclick = function() {
            _dataBusiness.getCharactersByQuote(character.char_id).then((dataQuote)=>{
                // Pasamos a la función el resultado de ambos fetchs
                _utils.showCharacter(character, dataQuote);
            });
        };
        nodes.push(node);
    }
...
},{"./styles.css":"lW6qc","./data-business":"iM7Bx","./utils":"en4he"}],"lW6qc":[function() {},{}],"iM7Bx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCharacters", ()=>getCharacters
);
parcelHelpers.export(exports, "getCharactersByQuote", ()=>getCharactersByQuote
);
...
function getCharactersByQuote(id) {
    return fetch("https://www.breakingbadapi.com/api/quotes/" + id).then((response)=>{
        // El fetch nos devolverá un promise con los datos en formato json
        return response.json();
    });
}
...
const showCharacter = (character, characterQuote)=>{
    ...
    characterDetail.appendChild(createParagraph("Id: " + character.char_id));
    // Resultado del fetch para el quote es un objeto con un array con 1 único elemento, accedemos a él a través del [0]   
    characterDetail.appendChild(createParagraph("Quote: " + characterQuote[0].quote));
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7nZVA","8lqZg"], "8lqZg", "parcelRequire0259")
