...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../../Users/Angeles/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../../Users/Angeles/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../../Users/Angeles/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../Users/Angeles/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/data-business.js":[function(require,module,exports) {
"use strict";
...
exports.getCharactersByQuote = getCharactersByQuote;
...
function getCharactersByQuote(id) {
  return fetch("https://www.breakingbadapi.com/api/quotes/" + id).then(function (response) {
    // El fetch nos devolverá un promise con los datos en formato json
    return response.json();
  });
}
...
var showCharacter = function showCharacter(character, characterQuote) {
  ...
  characterDetail.appendChild(createParagraph("Id: " + character.char_id)); // Resultado del fetch para el quote es un objeto con un array con 1 único elemento, accedemos a él a través del [0]   
...
DataBusiness.getCharacters().then(function (data) {
  ...
  document.getElementById("root").innerText = ""; // Listado de personajes = resultado del fetch a la api 

  var characters = data;
  var nodes = []; // Recorremos el listado y para cada personaje y su click realizamos una acción  
  ...
  try {
    var _loop = function _loop() {
      ...
      node.onclick = function () {
        DataBusiness.getCharactersByQuote(character.char_id).then(function (dataQuote) {
...
},{"./styles.css":"src/styles.css","./data-business":"src/data-business.js","./utils":"src/utils.js"}],"../../../../Users/Angeles/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
