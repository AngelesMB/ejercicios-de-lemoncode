...
},{"axios":"../node_modules/axios/index.js"}],"common/api/common.api.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"core/content/img/email_icon.svg":[function(require,module,exports) {
...
},{"../../core/content/img/email_icon.svg":"core/content/img/email_icon.svg","../../core/content/img/telefono_icon.svg":"core/content/img/telefono_icon.svg","../../core/router":"core/router/index.js"}],"pages/property-list/property-list.mappers.js":[function(require,module,exports) {
"use strict";
...
var mapFilterToQueryParams = function mapFilterToQueryParams(filter) {
  var queryParams = ''; // Si filter tiene valor, es decir, se ha seleccionado algo dentro de saleTypeId,
...
},{}],"pages/property-list/property-list.constants.js":[function(require,module,exports) {
"use strict";
...
// Constantes que usaremos para mostrar desplegables desde habitación a precio máximo
// En lugar de tenerlo en el html tenemos aquí el listado para poder reutilizarlo
var roomOptions = [{
  id: '1',
  name: '+1'
}, {
...
Promise.all([(0, _propertyList.getPropertyList)(), (0, _common.getSaleTypeList)(), (0, _common.getProvinceList)()]).then(function (resultList) {
  ...
  loadPropertyList(propertyList); // Pintamos las opciones de filtrado trayendo datos maestros desde el servidor

  (0, _propertyList2.setOptions)(saleTypeList, 'select-sale-type', '¿Qué venta?');
  (0, _propertyList2.setOptions)(provinceList, 'select-province', '¿Dónde?'); // Pintamos las opciones de filtrado trayeno datos maestros desde cliente

  (0, _propertyList2.setOptions)(_propertyList4.roomOptions, 'select-room', '¿Habitaciones?');
  (0, _propertyList2.setOptions)(_propertyList4.bathroomOptions, 'select-bathroom', '¿Cuartos de baño?');
  (0, _propertyList2.setOptions)(_propertyList4.minPriceOptions, 'select-min-price', 'Mín (EUR)');
  (0, _propertyList2.setOptions)(_propertyList4.maxPriceOptions, 'select-max-price', 'Máx (EUR)');
...
var loadPropertyList = function loadPropertyList(propertyList) {
  var viewModelPropertyList = (0, _propertyList3.mapPropertyListFromApiToViewModel)(propertyList); // Pintamos las filas con cada propiedad mappeada
